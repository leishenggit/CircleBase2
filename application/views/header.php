...
<title>CircleBase V2</title>
<link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.png">
<base href="<?php echo site_url();?>"/>
<!-- Bootstrap -->
<link rel="stylesheet" type="text/css" href="assets/DataTables/datatables.min.css"/>
<link rel="stylesheet" href="assets/css/navbar.css">
<link rel="stylesheet" type="text/css" href="assets/css/custom.1.css"/>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="welcome/index">CircleBase V2</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class=<?php if(isset($current) && $current=='links') echo 'active';?>><a  href="<?php echo site_url('welcome/links')?>"><span class="glyphicon glyphicon-random"></span> Data Source</a></li>
